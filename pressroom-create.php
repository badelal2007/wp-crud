<?php
function mmm_press_room_create() {
    ...
    if (isset($_POST['insert'])) {
        ...
        if($validator->passed()) {
            ...
            $_SESSION['pres_room_msg'] = '<div class="updated"><p>"'.$title . '" Press Room added successfully.</p></div>';
        }
    }
            ...
            <form method="post" action="<?php echo $_SERVER['REQUEST_URI']; ?>">
                <div id="post-body-content" class="form-section">
                    ...
                    <div class="container-right">
                        ...
                        <div class="inside">
                            <input style="padding: 4px 17px; font-size: large;" type='submit' name="insert" value='Save' class='pressroom-btn-default button1'>
